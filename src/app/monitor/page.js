...
export default function Users(){
  ...
  <h1>Monitores O</h1>
  <div className='input'>
          <input id='cpf' name='cpf' onChange={handleInputChange} placeholder='CPF' className='input2'/>
          <input id='materia' name='materia' onChange={handleInputChange} placeholder='Matéria' className='input2'/>
